...
namespace Ordering.Infrastructure.Persistence
{
    public class OrderContext : DbContext
    {
        ...
        private static LambdaExpression MultiTenantExpression<T>(OrderContext orderContext)
            where T : EntityBase, IMultiTenant
        {
            Expression<Func<T, bool>> tenantFilter = x => x.TenantId == orderContext.TenantID;
            return tenantFilter;
        }
